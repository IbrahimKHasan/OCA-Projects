                ...
                <div class="carousel-item active">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{asset('web/assets/images/slider/1.png')}}" alt="Hero">
                        </div> <!-- slider-imgae -->
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Get Started with Math Exam</h1>
                                    <p class="text">We blend insights and strategy to create digital products for forward-thinking organisations.</p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#exams">GET STARTED</a></li>
                                    </ul>
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{asset('web/assets/images/slider/2.png')}}" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Get Started with Physics Exam</h1>
                                    <p class="text">We blend insights and strategy to create digital products for forward-thinking organisations.</p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#exams">GET STARTED</a></li>
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{asset('web/assets/images/slider/3.png')}}" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
            </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        <div class=" text-center">
                            <h1 class="features-title">{{$exam->exam_name}}</h1>
                        </div>
                        <br>
                        <div class="features-icon">
                            <img class="shape" src="{{asset('img/'.$exam->exam_image)}}" alt="Shape" width="400px" height="200px">
                        </div>
                        <div class="features-content">
                            <p class="text">{{$exam->exam_description}}</p><br>
                            <h6>Time: 3 Minutes</h6>
                            @if (Auth::user() !== null)
                                <a class="features-btn" href="{{route('laraxam.show',$exam->exam_id)}}">Strat Exam</a>
                            @endif
                            @if (Auth::user() == null)
                                <a class="features-btn" href="{{route('register')}}">Create Account To Start Exam</a>
                            @endif
                        </div>
                    </div> <!-- single features -->
                </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row no-gutters grid mt-50">
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="{{asset('web/assets/images/portfolio/1.png')}}" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="assets/images/portfolio/1.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="{{asset('web/assets/images/portfolio/shape.svg')}}" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="{{asset('web/assets/images/portfolio/2.png')}}" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
